    ...
    return (
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sm:mx-10 lg:mx-20 mt-20 mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                    <div>
                        <img src="../public/images/jebba.webp" alt="Jebba" className="rounded-lg w-full h-auto" />
                    </div>
                    <div className="flex flex-col justify-between">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col justify-end">
                                <p className="pb-4">Jebba</p>
                                <p className="pb-4">BC03F128</p>
                                <p className="pb-4">60DT</p>
             ...
             <div className="relative w-full sm:w-96">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                 ...
                 <input className="w-full h-12 border-4 border-Rosy rounded-input-radius pl-10" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 pt-10 w-full max-w-5xl px-4 sm:px-0">
                            {[1, 2, 3, 4].map((item) => (
                            <div key={item} className="bg-greyBg p-4 rounded-lg w-full max-w-md mx-auto">
                                <div className="grid grid-cols-2 gap-4 items-center">
                                <img
                                    src="../public/images/jebba.webp"
                                    alt="Jebba"
                                ...
                                <div className="flex flex-col justify-between h-full">
                                    ...
                                    <p>
                                        <strong className="font-bold">Prix:</strong> 900T
                                    </p>
                                    </div>
                                    <button className="bg-Rosy  text-white font-semibold py-2 block text-center text-buttonSize rounded-button-radius px-4 w-full">
                                    Voir détails produit
                                    </button>
                                </div>
                                </div>
                        ...
                        <div className="flex gap-4 justify-end  mt-9 lg:pr-36">
                            <button className="bg-Rosy hover:bg-Rosy text-white font-semibold py-2 text-center text-buttonSize rounded-button-radius" style={{ width: '141px', height: '53px' }}>
                                Confirmer
                            </button>
                            <button className="bg-white text-grenat border border-grenat font-semibold py-2 text-center text-buttonSize rounded-button-radius" style={{ width: '141px', height: '53px' }}>
                                Annuler
                            </button>
                        </div>
                    </div>
